...
<main class="container my-4" style="opacity:0;">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h4>Observadores</h4>
    <a href="insertar_observador.php" class="btn btn-success">Nuevo</a>
  </div>
  <div class="card">
    <div class="table-responsive">
      <table class="table align-middle mb-0">
        ...
        <?php
          ...
          $sql = "select id, nombre, identificacion, rol, fecha, hora, descripcion from observador";
          ...
          while ($fila = mysqli_fetch_assoc($tabla)) {
              ...
              echo "<td><span class='badge bg-primary'>".$fila['rol']."</span></td>";
              echo "<td>".$fila['fecha']."</td>";
              echo "<td>".$fila['hora']."</td>";
              echo "<td>".$fila['descripcion']."</td>";
              echo "<td>
                      <form action='modificar_observador.php' method='post'>
                        <input type='hidden' value='".$fila['id']."' name='id'>
                        <input type='submit' class='btn-secundary' value='Modificar'>
                      </form>
                    </td>";
              echo "<td>
                      <form action='eliminar_observador.php' method='post'>
                        <input type='hidden' value='".$fila['id']."' name='id'>
