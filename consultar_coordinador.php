...
<main class="container my-4" style="opacity:0;">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h4>Coordinadores</h4>
    <a href="insertar_coordinador.php" class="btn btn-success">Nuevo</a>
  </div>
  <div class="card">
    <div class="table-responsive">
      <table class="table align-middle mb-0">
        <thead class="table-light"><tr><th>ID</th><th>Nombre</th><th>Apellido</th><th>Cargo</th><th>Cédula</th><th>Jornada</th><th>Modificar</th><th>Eliminar</th></tr></thead>
        <tbody>
        	<?php
				$conexion=mysqli_connect("localhost","root","","tardes&asociados");
				$sql="select id_coordinador, nombre, apellido, cargo, cedula, jornada from coordinador";
				...
				while($fila=mysqli_fetch_assoc($tabla))
				      {
				        echo "<tr>";
				             ...
				             echo "<td><span class='badge bg-primary'>". $fila['cargo']."</span></td>";
				             echo "<td>". $fila['cedula']."</td>";
				             echo "<td>". $fila['jornada']."</td>";
				             echo "<td>
				                    <form action='modificar_coordinador.php'
				                    method='POST'>
				               ...
				               echo "<td>
				                    <form action='eliminar_coordinador.php'
				                    method='POST'>
				                    <input type='hidden' value='".$fila['id_coordinador']."'name='id_coordinador'>
